...
OPENING RETENTION HARD RULE — CHỐNG MỞ ĐẦU NHẠT:
- Câu/đoạn đầu tiên phải có ít nhất 1 thứ: lời buộc tội, vật chứng bất thường, quyền lợi bị khóa, hoặc câu thoại gây sốc.
- Trong 150 chữ đầu, độc giả phải hiểu ngay: nữ chính bị ép chuyện gì, ai ép, vật chứng nằm ở đâu, thua thì mất gì.
- Không bắt đầu bằng công thức mềm: “Tôi đứng giữa…”, “Ánh đèn…”, “Không khí…”, “Phòng khách…”, “Sảnh khách sạn…” trừ khi ngay cùng câu có cú ép/vật chứng/hậu quả.
- Đoạn 1 nên ngắn và có lực. Ưu tiên mở bằng câu thoại hoặc biến cố: “Cô ký đi.” / “Trong camera, người cầm chìa khóa là cô.” / “Hồ sơ của con cô bị tạm dừng.”
- Sau 3 đoạn đầu phải có một micro-turn: nữ chính phát hiện chi tiết lệch, phản diện nói hớ, người trung lập khựng lại, hoặc cái giá bị nâng lên.
- Mở chương viết tiếp không được recap dài. Nối từ chương trước tối đa 2 câu rồi lập tức đẩy sang hậu quả mới hoặc cảnh mới.
...
MARKET OPENING / GIỮ CHÂN ĐỘC GIẢ — HARD LOCK:
- Mục tiêu không phải văn đẹp; mục tiêu là người đọc click vào và không thoát trong 3 đoạn đầu.
- 150 chữ đầu bắt buộc có đủ 3 thứ: CÚ ÉP + VẬT CHỨNG/HẬU QUẢ + CÁI GIÁ NỮ CHÍNH SẮP MẤT.
- Không mở bằng tả cảnh dài. Tả cảnh tối đa 1 câu rồi phải có hành động/lời buộc tội.
- Câu đầu nên là một trong các kiểu:
  + “Khi tôi đến nơi, [quyền/người thân/vật chứng] đã bị [khóa/đưa ra/công bố/đổi tên].”
  + “Tên tôi bị đọc lên trước [đám đông/người có quyền] cùng với [vật chứng sai].”
  + “Trước khi tôi kịp giải thích, [người có quyền] đã đặt [vật chứng] xuống trước mặt tôi.”
  + Một câu thoại ép thẳng: “Ký đi.” / “Xin lỗi ngay.” / “Cô còn định chối à?”
- Đoạn 1: ném nữ chính vào sự việc đang xảy ra, không kể lùi.
- Đoạn 2: cho thấy ai đang ép, đám đông/người có quyền nghiêng về ai.
- Đoạn 3: cho biết nếu nữ chính thua thì mất gì cụ thể: con, hồ sơ, quyền thừa kế, việc làm, danh dự, hợp đồng, người yếu thế.
- Đoạn 4–5: nữ chính nhìn ra một chi tiết lệch rất nhỏ và chọn một hành động cụ thể.
- Trong 5 đoạn đầu cấm lan man về quá khứ, cấm giải thích pháp lý/hệ thống như báo cáo, cấm ẩn dụ thơ tối nghĩa.
- Mỗi chương phải có nhịp dopamine: cứ 600–900 chữ phải có một cú nhích thế trận: lời ép mới, bằng chứng lệch, người đổi thái độ, hậu quả tăng, hoặc nữ chính phản đòn nhỏ.
- Độc giả phải luôn thấy câu hỏi “rồi cô ấy xoay kiểu gì?” chứ không phải chỉ đọc nữ chính đi thu thập tài liệu.
- Nếu target chapters là random 8–20, chương hiện tại phải bám đúng pha của target, không viết mặc định như truyện 15 chương.
...
25. 3 đoạn đầu có kéo được người đọc không? Nếu mở bằng tả cảnh/không khí mà chưa có cú ép, phải viết lại bằng lời buộc tội/vật chứng/hậu quả.
26. Trong 150 chữ đầu đã rõ ai ép nữ chính, ép bằng gì, thua mất gì chưa? Nếu chưa, viết lại đoạn mở.
