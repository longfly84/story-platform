...
- Không được nén 1000 thể loại thành vài format cố định như: hồ sơ / camera / ghi âm / log / email / metadata / header / forward / phong tỏa / luật sư / hội đồng / hot search.
- Chỉ dùng hồ sơ, camera, log, email, metadata, header, forward, phong tỏa, luật sư, cổ phần, hot search nếu chúng thật sự có trong genre/story seed. Nếu không, hãy dùng vật chứng, địa điểm, quan hệ và áp lực riêng của genre.
- CẤM lặp xương sống “bị tố công khai bằng vật nhỏ → người trung lập kiểm tra → chương 2 lộ email/header/file/metadata → tạm hoãn quyền”. Nếu chương 1 đã là một vật chứng nhỏ, chương 2 phải đổi sang đường đời sống khác: người giao ca, biên nhận, hóa đơn, lịch hẹn, vật bị tráo, lời khai ngập ngừng, vết cắt, vết mực, địa điểm mới.
...
- Không để 2 chương liên tiếp cùng công thức “ảnh/file/email/header/metadata/forward → xác minh → tạm hoãn”. Mỗi chương phải đổi loại bằng chứng, đổi arena, đổi người có quyền và đổi hậu quả.
...
- Không được quay về vòng lặp hồ sơ/camera/log/email/header/metadata/forward/phong tỏa/pháp lý nếu seed không yêu cầu rõ.
