...
8) CỔNG SOÁT TỪ SAI NGỮ CẢNH / CỤM GƯỢNG:
- Không dùng nhầm từ gần âm/gần nghĩa làm sai câu.
  + Sai: “đúng lúc chương cần cô nhất”
  + Đúng: “đúng lúc chương trình cần cô nhất”
- Không viết cụm vô nghĩa hoặc sai thói quen tiếng Việt.
  + Sai: “mọi thứ đã có sẵn bằng tay”
  + Đúng: “bà ta nhếch môi, như thể đã nắm chắc phần thắng trong tay”
- Không dùng ẩn dụ gượng.
  + Sai: “mọi ánh mắt quay về cô như một cây kim chỉ huy”
  + Đúng: “mọi ánh mắt lập tức đổ dồn về phía cô”
- Không để cụm thiếu từ bị/được/đang/đã làm sai trạng thái.
  + Sai: “tấm thẻ mà giờ đây gọi là bằng chứng”
  + Đúng: “tấm thẻ nhỏ bé đang bị biến thành bằng chứng”
- Không dùng cụm sai thói quen.
  + Sai: “mở ra một lối tháo”
  + Đúng: “mở ra một lối thoát”

9) POV PRONOUN / THÁI ĐỘ NGÔI KỂ:
- Trong ngôi kể “tôi”, đại từ phải phản ánh thái độ của nữ chính.
- Người đang ép/sỉ nhục/vu oan/đe dọa nữ chính: phần tự sự nên dùng “bà ta”, “ông ta”, “anh ta”, “cô ta”, “hắn” hoặc tên riêng để tạo khoảng cách đối kháng.
- Không dùng “bà/ông/cô/anh” quá trung tính trong cảnh nữ chính đang bị đối đầu công khai, trừ khi đó là lời thoại cần giữ phép lịch sự.
- Ví dụ:
  + Nhạt: “Bà nhếch môi, vẻ mặt như người đã nắm chắc phần thắng.”
  + Đúng: “Bà ta nhếch môi, như thể đã nắm chắc phần thắng trong tay.”

10) HEADING / OUTPUT CLEANUP LOCK:
...
11) 5 ĐOẠN ĐẦU PHẢI VƯỢT QUA BÀI TEST CÂU TIẾNG VIỆT:
...
function getVietnameseWordChoiceAndPronounGateInstruction() {
  return `
VIETNAMESE WORD CHOICE + POV PRONOUN GATE — CỔNG SOÁT TỪ SAI NGỮ CẢNH / ĐẠI TỪ THEO THÁI ĐỘ:
Mục tiêu: chặn các câu "đúng ý nhưng sai tai người Việt", đặc biệt là lỗi dùng nhầm từ, cụm gượng, đại từ quá trung tính làm mất lực drama.

1) ĐẠI TỪ PHẢI BÁM NGÔI KỂ "TÔI" VÀ THÁI ĐỘ CỦA NỮ CHÍNH:
- Trong ngôi kể thứ nhất, cách gọi nhân vật phải phản ánh quan hệ và cảm xúc của nữ chính tại thời điểm đó.
- Người đang công khai ép, sỉ nhục, vu oan, đe dọa hoặc đối đầu với nữ chính: ưu tiên "bà ta", "ông ta", "anh ta", "cô ta", "hắn" hoặc gọi thẳng tên riêng tùy tuổi/tầng quan hệ.
- Không dùng "bà", "ông", "cô", "anh" quá trung tính/lịch sự trong cảnh đối đầu nếu nữ chính đang bị chèn ép.
- Nếu nữ chính còn cần giữ phép lịch sự trước đám đông, lời thoại có thể gọi "bà Tống", "Ôn tổng", nhưng phần tự sự nội tâm có thể dùng "bà ta", "anh ta" để tạo khoảng cách đối kháng.
- Không lạm dụng "bà ta/cô ta/anh ta" cho đồng minh, người yếu thế, cấp dưới thân cận hoặc người nữ chính đang bảo vệ.

Ví dụ:
  + Sai/nhạt: "Bà nhếch môi, vẻ mặt như người đã nắm chắc phần thắng."
  + Đúng hơn: "Bà ta nhếch môi, như thể đã nắm chắc phần thắng trong tay."
  + Sắc hơn: "Bà ta nhếch môi, ánh mắt của kẻ tưởng mình đã nắm chắc phần thắng."
  + Sai nếu đối thủ là nam trẻ/cùng thế hệ: "Ông ta nhìn tôi..."
  + Đúng: "Anh ta nhìn tôi...", "Hắn nhìn tôi...", hoặc gọi tên riêng.

2) CẤM DÙNG NHẦM TỪ GẦN ÂM / GẦN NGHĨA LÀM SAI CÂU:
- Phải kiểm tra từ nào đang được dùng đúng nghĩa trong ngữ cảnh chưa.
- Sai: "đúng lúc chương cần cô nhất"
- Đúng: "đúng lúc chương trình cần cô nhất"
- Tốt hơn: "đúng lúc chương trình cần cô đứng ra xử lý nhất"
- Sai: "thẻ phụ huynh dùng để vào phòng tập" nếu bối cảnh đang là phòng trẻ/khu chăm sóc trẻ.
- Đúng: "thẻ phụ huynh dùng để ra vào khu chăm sóc trẻ", hoặc "thẻ phụ huynh của khu phòng trẻ".

3) CẤM CỤM TIẾNG VIỆT VÔ NGHĨA / DỊCH MÁY / SAI THÓI QUEN:
- Sai: "mọi thứ đã có sẵn bằng tay"
- Đúng: "mọi bằng chứng đã nằm sẵn trong tay bà ta"
- Đúng hơn: "bà ta nhếch môi, như thể đã nắm chắc phần thắng trong tay"
- Sai: "mở ra một lối tháo"
- Đúng: "mở ra một lối thoát"
- Có thể viết hình ảnh hơn: "trở thành đường tháo nút đầu tiên"
- Sai: "tấm thẻ mà giờ đây gọi là bằng chứng"
- Đúng: "tấm thẻ giờ đây bị gọi là bằng chứng"
- Đúng hơn: "tấm thẻ nhỏ bé đang bị biến thành bằng chứng"

4) CẤM ẨN DỤ LẠ / GƯỢNG / KHÔNG PHẢI VĂN TRUYỆN THƯƠNG MẠI VIỆT:
- Sai: "mọi ánh mắt quay về cô như một cây kim chỉ huy"
- Đúng: "mọi ánh mắt lập tức đổ dồn về phía cô"
- Tốt hơn nếu cần hình ảnh: "cả sảnh quay phắt lại, như thể cô vừa kéo tất cả ánh sáng về phía mình"
- Sai: "mồi câu bắt buộc phải hé lộ"
- Đúng: "một câu hỏi buộc họ phải để lộ người đứng sau"
- Đúng hơn: "Tôi không van xin. Tôi chỉ đặt một câu hỏi khiến họ không thể tiếp tục giấu người đã chụp ảnh."

5) HỘI THOẠI CẤP DƯỚI / TRỢ LÝ PHẢI ĐÚNG VAI VÀ ĐÚNG NGHIỆP VỤ:
- Trợ lý báo cáo khẩn cấp phải rõ nguồn, rõ hành động, có kính ngữ vừa đủ.
- Sai/yếu: "Dạ, chị... em xem nhóm rồi. Có một bản nháp thông cáo được gửi và bị chuyển tiếp. Người ta đã in ra."
- Đúng: "Dạ chị, em vừa kiểm tra nhóm nội bộ. Có một bản nháp thông cáo bị gửi nhầm, sau đó bị người khác chụp lại và chuyển tiếp. Bản in kia chắc là từ ảnh chụp đó ạ."
- Sai cụt: "Tài khoản ẩn."
- Đúng: "Người gửi dùng tài khoản ẩn danh, hiện em chưa truy được người đứng sau ạ."

6) CƠ CHẾ VẬT CHỨNG PHẢI KHỚP BỐI CẢNH:
- Nếu vật chứng là thẻ phòng trẻ, phải gọi đúng chức năng: thẻ phụ huynh/khu chăm sóc trẻ/phòng trẻ, không tự chuyển thành thẻ phòng tập nếu chưa giải thích.
- Nếu vật chứng là bản nháp thông cáo, phải làm rõ chuỗi: gửi nhầm → bị chụp lại → bị chuyển tiếp → bị in ra.
- Nếu vật chứng là ảnh/video/camera, phải nói rõ ai có quyền xem, ai chụp, ai chuyển, vì sao nó gây hậu quả.
- Không để vật chứng bị gọi sai tên qua các đoạn khác nhau.

7) SELF TEST BẮT BUỘC:
- Trước khi trả output, soi lại toàn bộ 5 đoạn đầu, toàn bộ hội thoại và các câu có đại từ "bà/ông/cô/anh".
- Nếu nhân vật đang đối đầu nhưng câu tự sự vẫn gọi trung tính làm mất lực, sửa đại từ theo thái độ của nữ chính.
- Nếu câu có cụm nghe lạ, hãy thay bằng cách nói Việt Nam phổ thông, rõ nghĩa, có lực truyện.
`.trim()
}
...
- “đúng lúc chương cần cô nhất” → “đúng lúc chương trình cần cô nhất”.
- “mọi thứ đã có sẵn bằng tay” → “bà ta nhếch môi, như thể đã nắm chắc phần thắng trong tay”.
- “mọi ánh mắt quay về cô như một cây kim chỉ huy” → “mọi ánh mắt lập tức đổ dồn về phía cô”.
- “mồi câu bắt buộc phải hé lộ” → “một câu hỏi buộc họ phải để lộ người đứng sau”.
- “tấm thẻ mà giờ đây gọi là bằng chứng” → “tấm thẻ nhỏ bé đang bị biến thành bằng chứng”.
- “mở ra một lối tháo” → “mở ra một lối thoát”.

ĐẠI TỪ THEO THÁI ĐỘ:
- Trong ngôi kể “tôi”, người đối đầu/ép/sỉ nhục/vu oan nữ chính nên được gọi trong phần tự sự là “bà ta/ông ta/anh ta/cô ta/hắn” hoặc tên riêng, không gọi quá trung tính nếu làm mất lực drama.
- Ví dụ: “Bà ta nhếch môi, như thể đã nắm chắc phần thắng trong tay.”
`.trim()
}
...
export function buildChapterPrompt(payload: NormalizedGeneratePayload) {
  ...
  const vietnameseWordChoiceAndPronounGateInstruction = getVietnameseWordChoiceAndPronounGateInstruction()
...
${vietnameseWordChoiceAndPronounGateInstruction}
...
25. Có dùng nhầm từ gần âm/gần nghĩa không? Ví dụ “chương” thay vì “chương trình”, “lối tháo” thay vì “lối thoát”. Nếu có, sửa ngay.
26. Có cụm tiếng Việt vô nghĩa/gượng không? Ví dụ “mọi thứ đã có sẵn bằng tay”, “một cây kim chỉ huy”, “mồi câu bắt buộc phải hé lộ”. Nếu có, sửa bằng câu Việt tự nhiên.
27. Đại từ trong ngôi kể “tôi” đã phản ánh đúng thái độ chưa? Nếu nhân vật đang ép/sỉ nhục/vu oan nữ chính, phần tự sự không được quá trung tính; ưu tiên “bà ta/ông ta/anh ta/cô ta/hắn” hoặc tên riêng khi hợp cảnh.
...
19. Nếu có lỗi dùng nhầm từ/cụm sai thói quen tiếng Việt như “chương cần cô”, “mọi thứ có sẵn bằng tay”, “một cây kim chỉ huy”, “mở ra một lối tháo”, phải sửa ngay.
20. Nếu phần tự sự trong ngôi “tôi” gọi đối thủ quá trung tính làm mất lực drama, phải sửa đại từ theo thái độ: “bà ta/ông ta/anh ta/cô ta/hắn” hoặc tên riêng.
21. Nếu trợ lý/cấp dưới báo cáo quá đời thường hoặc thiếu nghiệp vụ, phải rewrite thành câu có kính ngữ, nguồn thông tin và hành động kiểm tra rõ ràng.
...
- Không giữ lỗi dùng nhầm từ/cụm gượng: “chương cần cô”, “mọi thứ có sẵn bằng tay”, “một cây kim chỉ huy”, “mồi câu bắt buộc phải hé lộ”, “mở ra một lối tháo”.
- Không gọi nhân vật đối đầu quá trung tính trong phần tự sự nếu cảnh cần thái độ đối kháng; dùng đại từ theo góc nhìn nữ chính.
