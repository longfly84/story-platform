...
function getVietnameseGrammarSystemInstruction() {
  return `
VIETNAMESE GRAMMAR SYSTEM GATE — VIẾT THEO NGỮ PHÁP VÀ THÓI QUEN TIẾNG VIỆT, KHÔNG VÁ LỖI LẺ:
Mục tiêu: trước khi trả output, phải biên tập bằng hệ quy chiếu tiếng Việt tự nhiên. Không chỉ né blacklist. Câu nào không qua các tầng dưới đây thì phải viết lại.

A) CẤU TRÚC CÂU CƠ BẢN: CHỦ THỂ — HÀNH ĐỘNG — ĐỐI TƯỢNG — TRẠNG THÁI
- Mỗi câu tường thuật phải xác định rõ ai làm, làm gì, tác động vào ai/cái gì, việc đó đã/đang/sắp/chỉ bị đồn là xảy ra.
- Không để vật vô tri làm hành động sai nghĩa nếu tiếng Việt không nói vậy.
  Sai: “hợp đồng ủy quyền chuyển giao quyền điều hành”.
  Đúng: “Nhà kính Hạ Vân đã ký hợp đồng ủy quyền, chuyển giao tạm thời quyền điều hành”.
  Đúng: “quyền điều hành tạm thời đã được chuyển cho bên thứ ba thông qua một hợp đồng ủy quyền”.
- Không bỏ mất các từ trạng thái quan trọng: đã, đang, bị, được, vừa, sắp, từng, vốn, được cho là, bị nghi là.
- Với tin đồn/sự kiện đã xảy ra, phải dùng đúng thời thái: “có tin đồn rằng… đã…”, “có thông tin cho rằng… đã được…”.

B) KẾT HỢP TỪ / COLLOCATION TIẾNG VIỆT:
- Chỉ dùng những cụm người Việt thật sự dùng. Không tự ghép danh từ + động từ + tính từ theo kiểu máy dịch.
- Nếu một cụm nghe lạ tai khi đọc lớn, phải thay bằng cụm đời thường hơn.
- Cấm kiểu ghép chữ vô nghĩa: “mép có sự chia phần”, “mặt là một tấm bạt lễ nghi”, “đạo đứt”, “lối tháo”, “tròng đầy thách thức”, “bị đặt vào tay sai người”.
- Ưu tiên cụm rõ nghĩa:
  “khóe môi lộ vẻ tính toán”, “vẻ mặt lịch sự đến mức giả tạo”, “khiến sự việc nghiêm trọng hơn”, “lối thoát”, “giọng đầy vẻ thách thức”, “bị đặt vào sai vị trí trong một ván cờ đã sắp sẵn”.

C) ĐẠI TỪ VÀ THÁI ĐỘ TRONG NGÔI KỂ “TÔI”:
- Đại từ phải phản ánh quan hệ và cảm xúc của nữ chính.
- Người đang ép, sỉ nhục, vu oan, thao túng nữ chính: dùng “bà ta/ông ta/anh ta/cô ta/hắn” hoặc tên riêng khi cần tạo khoảng cách đối kháng.
- Người trung lập: dùng chức danh/tên riêng.
- Đồng minh/cấp dưới: dùng tên riêng + vai quan hệ tự nhiên.
- Không dùng “bà/ông/cô/anh” quá trung tính trong cảnh đối đầu nếu làm mất lực drama.
- Không đổi đại từ lung tung trong cùng một cảnh.

D) HỘI THOẠI ĐÚNG VAI XÃ HỘI:
- Trợ lý/cấp dưới nói với nữ chính là sếp phải có kính ngữ vừa đủ: “Dạ chị…”, “em vừa kiểm tra…”, “em chưa xác minh được ạ”.
- Phóng viên/hội đồng/luật sư phải hỏi như người thật, không nói câu cụt kiểu dịch máy.
...
- Nhân vật không được nói quá đủ như báo cáo kỹ thuật. Câu thoại phải có ý đồ: ép, né, châm chọc, thử phản ứng, đe dọa, xin lỗi, hoặc xác minh.

E) DANH TỪ, LƯỢNG TỪ, BỔ NGỮ PHẢI ĐỦ:
- Không viết thiếu “của”, “bị”, “được”, “đang”, “đã”, “một”, “chiếc”, “tấm”, “bản”, “dòng”, “người”.
- Sai: “Trợ lý tôi trả lời”. Đúng: “Trợ lý của tôi trả lời”.
- Sai: “tấm thẻ mà giờ đây gọi là bằng chứng”. Đúng: “tấm thẻ nhỏ bé đang bị biến thành bằng chứng”.
- Sai: “đúng lúc chương cần cô nhất”. Đúng: “đúng lúc chương trình cần cô nhất”.

F) LOGIC NGỮ NGHĨA TRONG CẢNH:
- Mọi vật chứng phải có cầu nối logic với hậu quả.
- Nếu có thẻ phòng trẻ thì phải gọi đúng hệ thống: thẻ phụ huynh / thẻ ra vào khu chăm sóc trẻ / thẻ phòng trẻ, không lẫn sang phòng tập nếu chưa giải thích.
- Nếu có bản nháp thông cáo, phải rõ chuỗi: ai gửi nhầm, ai chụp lại, ai chuyển tiếp, ai in ra, nó gây hậu quả gì.
- Nếu có người giao hàng/nhân chứng/nhân viên xuất hiện, phải cài lý do họ có mặt. Không tự thả nhân vật mới ở cuối cảnh để làm twist.

G) ẨN DỤ VÀ HÌNH ẢNH PHẢI TIẾT CHẾ:
- Không dùng ẩn dụ lạ, trừu tượng hoặc hơi kinh dị nếu không phục vụ cảnh.
- Mỗi đoạn tối đa một hình ảnh so sánh. Nếu đã có ánh sáng/âm thanh/đồ vật thì không nhồi thêm ẩn dụ mới.
- Cấm kiểu: “cánh cửa như một lớp da”, “tiếng piano như viên đá lăn trên mặt hồ”, “câu nói không gào thét”, “nhân phẩm lộ ra giữa đám đông”.
- Sửa theo hướng cụ thể, đời hơn:
  “cánh cửa khép lại, ngăn bớt tiếng thì thầm ngoài hành lang”.
  “tiếng piano vẫn vang lên, đều đều đến khó chịu”.
  “anh ta nói rất khẽ, nhưng đủ khiến vài người đổi sắc mặt”.
  “danh dự của tôi bị đem ra mổ xẻ trước mặt tất cả”.

H) NHỊP VĂN THƯƠNG MẠI TRÊN ĐIỆN THOẠI:
- Độc giả đọc trên điện thoại. Câu mở đầu phải rõ, nhanh vào xung đột, không trang trí quá nhiều.
- Không mở chương bằng 4–5 lớp bối cảnh trừu tượng. Trong 3 đoạn đầu phải rõ: nữ chính ở đâu, bị ai ép, bị ép vì chuyện gì, hậu quả nếu thua là gì.
- Đoạn dài phải có hành động hoặc đối thoại chen vào. Không để toàn mô tả ánh sáng/âm thanh/không khí.

I) BÀI TEST CUỐI CÙNG:
Trước khi trả output, tự hỏi từng câu:
1. Người Việt có nói/viết cụm này không?
2. Chủ thể của câu có đúng không?
3. Câu có thiếu “đã/đang/bị/được/của” không?
4. Đại từ có đúng thái độ ngôi “tôi” không?
5. Câu này có đang trang trí bằng ẩn dụ thay vì kể chuyện không?
Nếu bất kỳ câu trả lời nào là “không chắc”, phải viết lại bằng câu đơn giản hơn, rõ hơn, đời hơn.
`.trim()
}
...
function getVietnamesePipelineEditorInstruction() {
  return `
PIPELINE EDITOR LOCK — KHÔNG VÁ LỖI LẺ, PHẢI BIÊN TẬP THEO CƠ CHẾ:
Mục tiêu: giảm lỗi kiểu AI tự ghép chữ bằng cách kiểm tra toàn bộ câu theo vai trò biên tập viên tiếng Việt, không chỉ né vài blacklist.

1) LINE-LEVEL NATURALNESS PASS:
- Đọc lại từng câu như một người Việt biên tập truyện thương mại.
- Câu nào nghe đúng ý nhưng sai tai, sai kết hợp từ, sai thói quen tiếng Việt hoặc như máy dịch thì phải viết lại ngay.
- Không giữ câu chỉ vì “đọc vẫn hiểu”. Tiêu chuẩn là đọc thuận miệng, đúng vai, đúng cảnh.

2) CẤM CỤM TỪ BỊA / SAI THÓI QUEN TIẾNG VIỆT:
- Sai: “hôm nay góc bàn này bị đặt vào tay sai người”
  Đúng: “hôm nay tôi bị đặt vào sai vị trí trong một ván cờ đã sắp sẵn”
  Tự nhiên hơn: “hôm nay tôi trở thành người bị đem ra chất vấn trước tất cả”
- Sai: “giọng anh ta tròng đầy thách thức”
  Đúng: “giọng anh ta đầy vẻ thách thức”
  Tốt hơn: “giọng anh ta cố tình kéo căng từng chữ, như chỉ chờ tôi mắc lỗi”
- Sai: “Lời của Ninh Tâm đặt một đạo đứt vào giữa sự việc”
  Đúng: “Lời của Ninh Tâm khiến sự việc lập tức nghiêm trọng hơn”
  Tốt hơn: “Lời của Ninh Tâm khiến cả căn phòng hiểu rằng chuyện này không chỉ còn là tranh chấp nội bộ”
- Sai: “nó kéo một hơi dài”
  Đúng: “đủ tạo ra một khoảng chững”
- Sai: “nói như trao đổi quyền lợi trước công chúng”
  Đúng: “nói như thể đó là một đề nghị rất công bằng”
  Sắc hơn: “nói bằng giọng của kẻ đang giả vờ nhường cho tôi một lối thoát”
- Sai: “là người chọn cứu mình”
  Đúng: “nếu muốn tự cứu mình, tôi không được để cảm xúc dẫn đường”
  Sắc hơn: “muốn thoát khỏi cái bẫy này, tôi phải tỉnh táo hơn tất cả bọn họ”
- Sai: “quyền lực đã tạm chuyển hướng khỏi tôi sang nhóm muốn khóa miệng tôi”
  Đúng: “thế trận tạm thời nghiêng về phía những người muốn buộc tôi im lặng”

3) KIỂM TRA CÂU THEO 4 CỘT:
Mỗi câu quan trọng phải đúng 4 cột:
- Chủ thể: ai/người nào/đơn vị nào?
- Hành động: làm gì, ép gì, tung gì, giấu gì?
- Đối tượng: ai/cái gì bị tác động?
- Trạng thái thời gian: đã xảy ra, đang xảy ra, sắp xảy ra, hay chỉ là tin đồn?
Nếu thiếu một cột, phải viết lại.

4) KHÔNG ĐỂ TÊN TRUYỆN / TÊN CHƯƠNG GIỐNG SEED KỸ THUẬT:
- Cấm tên truyện quá dài kiểu mô tả motif: “Sao kê ngân hàng có dòng phụ/điều khoản phụ làm lộ người thao túng Đổi Nghĩa”.
- Cấm dấu “/” trong tên truyện/tên chương trừ khi là tên thương hiệu thật.
- Cấm tên chứa cụm kỹ thuật thô: “dòng phụ/điều khoản phụ”, “metadata”, “log”, “cache”, “reference”, “access”.
- Tên nên ngắn, có hình ảnh, dễ nhớ: “Dòng Phụ Trên Sao Kê”, “Mã B-452A”, “Góc Kính Du Thuyền”, “Hai Tiếng Để Lật Ngược”.

5) MOTIF LEGAL/FINANCE FATIGUE LOCK:
- Không được mặc định kéo mọi truyện về: sao kê → hợp đồng ủy quyền → khóa quyền truy cập → đình chỉ quyền ký → bản sao có mã khác.
- Nếu bắt buộc dùng tài liệu/ngân hàng/pháp lý, cảnh phải có ít nhất 50% sức nặng đời sống/cảm xúc: đứa trẻ, cô nhi viện, người chăm sóc, khoản lương, mẹ bệnh, người lao động, danh dự gia đình, lựa chọn đau.
- Vật chứng chỉ là ngòi nổ; thứ giữ người đọc phải là con người bị ảnh hưởng.

6) STORY EDITOR PASS PHẢI SỬA THẬT:
- Nếu bản nháp có câu gượng, editor pass không được giữ nguyên.
- Nếu 5 đoạn đầu còn cụm sai tai, phải rewrite 5 đoạn đầu.
- Không được chỉ thêm vài câu quanh lỗi; phải sửa tận gốc câu hỏng.
`.trim()
}
...
export function buildChapterPrompt(payload: NormalizedGeneratePayload) {
  ...
  const vietnamesePipelineEditorInstruction = getVietnamesePipelineEditorInstruction()
  const vietnameseGrammarSystemInstruction = getVietnameseGrammarSystemInstruction()
...
${vietnamesePipelineEditorInstruction}

${vietnameseGrammarSystemInstruction}
...
20. Có câu nào tự ghép từ lạ/ẩn dụ quá tay/thiếu từ quan hệ như của-bị-được-đã-đang không? Nếu có, viết lại bằng câu đơn giản, rõ và đúng thói quen tiếng Việt.
...
15. Trước khi trả output, xóa heading chương bị lặp, xóa dòng "---" thừa ở đầu/cuối phần đọc, xóa tên truyện bị lặp trước tiêu đề chương, và đảm bảo chỉ còn đúng một dòng "# Chương N — ..." trong phần đọc.
16. Chạy Vietnamese Grammar System Gate như một lượt biên tập cuối: sửa mọi câu tự ghép từ lạ, sai chủ thể, sai thời thái, sai đại từ, thiếu của/bị/được/đã/đang, hoặc ẩn dụ quá tay. Không giữ câu chỉ vì đọc vẫn hiểu.
