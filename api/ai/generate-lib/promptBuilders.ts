...
3) METAPHOR DIET — GIẢM ẨN DỤ XUỐNG MỨC NGƯỜI THẬT:
- Trong mỗi 700 chữ, chỉ được dùng tối đa 1 câu có “như”.
- Trong 5 đoạn đầu, hạn chế tối đa so sánh. Ưu tiên cảnh rõ, hành động rõ, đối thoại rõ.
- Không dùng chuỗi so sánh liên tiếp để tạo drama. Drama phải đến từ người ép, vật chứng, hậu quả, lựa chọn khó.
- Cấm lặp các hình ảnh sáo: như mũi dao, như lửa, như viên đá, như nhịp trống, như chiếc cân, như lớp kính, như lưỡi dao, như áo khoác ướt, như phiên xử, như phán quyết, như tảng băng.
- Không viết “bầu không khí nặng như...”, “ánh mắt như...”, “giọng như...”, “nụ cười như...” nếu có thể viết bằng hành động.
...
CÁCH VIẾT THAY THẾ:
- Sai: “bầu không khí nặng như phiên xử công khai”
  Đúng: “Cửa phòng khép lại. Không ai ngồi xuống. Ai cũng chờ tôi giải thích.”
- Sai: “mặt ông ta như người đã chuẩn bị sẵn để tuyên án”
  Đúng: “Ông ta đứng chắn ở cửa, tay cầm sẵn tờ khiếu nại.”
- Sai: “quyền lực nhà trường là một tảng băng”
  Đúng: “Chỉ cần Hạ Mẫn gửi email cho trường, hợp đồng của chúng tôi có thể bị treo ngay trong tuần.”
- Sai: “nụ cười nhẵn nhụi như muốn xé rách”
  Đúng: “Bà ta cười rất nhẹ, nhưng lời nói thì không chừa đường lui.”
- Sai: “ánh mắt lạnh như đã đọc xong một phán quyết”
  Đúng: “Cô ta nhìn tôi như thể mọi chuyện đã có kết luận.”
...
Nếu chương có hơn 1 câu so sánh trong 700 chữ đầu, cắt bớt so sánh và đổi sang hành động cụ thể.
`.trim()
}



function getLifeMotifScaleInstruction(payload: NormalizedGeneratePayload) {
  const storySeed = payload.storySeed as any
  const seedText = [
    payload.title,
    payload.promptIdea,
    ...
    storySeed?.storyPlan?.evidencePlan?.join(" | "),
  ]
    .filter(Boolean)
    .join(" | ")
  ...
  const isLifeMotif = /to giay|ghi chu|nhan chau|chau hoa|nap chai|ve ghe|phieu banh|phieu dat banh|goc anh|ruy-bang|rui bang|bong hoa|soi chi|the giat|mieng dan|vong tay|hop com|moc khoa|sanh chung cu|thang may|hieu sach|sap hoa|cho|tieu thuong|bao ve|shipper|bao mau|phu huynh/.test(normalized)

  return `
LIFE MOTIF SCALE LOCK — KHÓA TỈ LỆ ĐỜI SỐNG:
- Life motif detected: ${isLifeMotif ? "YES" : "NO"}.
- Nếu vật chứng là tờ giấy/ghi chú/nhãn chậu/nắp chai/phiếu bánh/góc ảnh/ruy-băng/bó hoa/vòng tay/thẻ giặt/sợi chỉ, chương 1 phải bám vật chứng đó và bối cảnh đời sống quanh nó.
- Không kéo quá sớm sang ngân hàng, di chúc, công chứng, hồ sơ pháp lý, hội đồng, tập đoàn, đối tác lớn, hợp đồng lớn, phong tỏa, khách sạn, phòng VIP, sao kê nếu seed không yêu cầu trực tiếp.
- Nếu cần áp lực, dùng áp lực đời thường trước: hàng xóm, phụ huynh, chủ tiệm, ban quản lý chung cư, bảo vệ, khách đứng xem, người giao hàng, cô giữ trẻ, nhân viên ca trực.
- Nếu cần tiền/bằng chứng tài chính, chỉ dùng như chi tiết phụ. Không để “biên lai/chuyển khoản/ngân hàng/di chúc” nuốt mất vật chứng chính.
- Không đưa “người quyền lực đủ giật hợp đồng”, “đối tác tập đoàn”, “bản di chúc mới công chứng” vào chương 1 trừ khi đó là seed gốc.
- Chương 1 phải có cảm giác như chuyện xảy ra ngoài đời: người đứng xem, điện thoại giơ lên, nhân chứng run, vật chứng nằm trên bàn/quầy/sảnh. Không biến thành buổi họp quyền lực.
`.trim()
}
...
export function buildChapterPrompt(payload: NormalizedGeneratePayload) {
  ...
  const lifeMotifScaleInstruction = getLifeMotifScaleInstruction(payload)
...
20. Trong 700 chữ đầu có quá 1 câu dùng “như” không? Nếu có, cắt bớt so sánh và viết lại bằng hành động cụ thể.
21. Có câu nào kiểu “bầu không khí nặng như...”, “ánh mắt lạnh như...”, “nụ cười như...”, “quyền lực là một tảng băng”, “như một câu chưa kết”, “như một mũi tên”, “viên bi bằng lời nói”, “mảnh ghép trên bàn cờ” không? Nếu có, rewrite ngay.
22. Nếu vật chứng đời sống mà chương 1 nhảy sang ngân hàng/di chúc/công chứng/hợp đồng lớn/quyền lực tập đoàn, hãy giảm cấp về áp lực đời sống trừ khi seed yêu cầu rõ.
20. Trong 700 chữ đầu có quá 1 câu dùng “như” không? Nếu có, cắt bớt so sánh và viết lại bằng hành động cụ thể.
21. Có câu nào kiểu “bầu không khí nặng như...”, “ánh mắt lạnh như...”, “nụ cười như...”, “quyền lực là một tảng băng” không? Nếu có, rewrite ngay.
...
15. Chương final phải qua Metaphor Diet: không nhồi “như mũi dao/như lửa/như phiên xử/như tảng băng/như một câu chưa kết/như một mũi tên/viên bi bằng lời nói/mảnh ghép bàn cờ”. Nếu thấy văn đang cố làm thơ, rewrite thành câu đời hơn.
16. Nếu motif là đời sống, chương final không được để ngân hàng/di chúc/công chứng/hợp đồng/tập đoàn chiếm trục chính khi vật chứng thật là nhãn chậu/tờ giấy/bó hoa/phiếu bánh/vòng tay.
15. Chương final phải qua Metaphor Diet: không nhồi “như mũi dao/như lửa/như phiên xử/như tảng băng”. Nếu thấy văn đang cố làm thơ, rewrite thành câu đời hơn.
