...
MARKET BENCHMARK — HỌC TỪ TRUYỆN ĐANG CHẠY TỐT, KHÔNG HỌC VĂN HOA:
- Mục tiêu không phải “văn hay hơn” truyện sưu tầm. Mục tiêu là cuốn như chúng, trả đũa nhanh như chúng, nhưng ít rác câu và ít metaphor AI hơn.
- Truyện mạng thắng bằng hook, áp lực, bằng chứng, phản đòn; không thắng bằng câu văn đẹp.
- Ưu tiên cú nhỏ nhưng đau: 1 tệ 8, 80.000 tệ, một dòng sao kê, một vé bị hoàn, một mã lệch, một ảnh chụp, một câu bêu trong nhóm.
- Mỗi chương nên có một hành động tạo khoái cảm ngay: hoàn vé, khóa thẻ, trả lì xì, gửi sao kê, yêu cầu mở lịch sử giao dịch, niêm phong bản gốc, gọi nhân chứng, rời nhóm, tắt máy.
- Phản diện phải tự làm người đọc ghét bằng lời đời thường, không cần narrator giảng đạo.
- Nữ chính càng bình tĩnh, hành động càng cụ thể thì payoff càng đã.
- Không kết bằng tuyên ngôn trừu tượng. Kết bằng điện thoại rung, nhóm chat im, người kia hoảng, thẻ bị khóa, vé bị hoàn, con dấu đặt xuống, hoặc một câu thoại lạnh.
...
Không được để 2 chương liên tiếp chỉ xoay quanh cùng một bằng chứng bằng cách đổi tên file/ảnh/phiếu. Chương mới phải có evidence step mới và payoff nhỏ mới.
...
- Cú "đã" tối thiểu: người có quyền tạm dừng quy trình, một nhân chứng chịu nói, phản diện bị buộc mở điện thoại/sao kê, đám đông im lại, hoặc nữ chính khóa được một quyền/vật chứng.
...
9) CHỐNG LẶP CHƯƠNG / CHỐNG TITLE TRÙNG:
- Tiêu đề chương không được trùng, không được cùng ý với chương trước.
- Nếu chương trước là “Ảnh Xóa Vội”, chương sau không được tiếp tục lấy ảnh đã xóa làm trung tâm; phải chuyển sang nguồn mới như phòng in, người giao ca, bản gốc, lịch sử thanh toán, nhân chứng, hoặc thông báo chính thức.
- Không dùng cùng một thao tác nữ chính trong 2 chương liên tiếp: đều yêu cầu đối chiếu, đều đọc file, đều gọi luật sư, đều giữ giấy tờ.
- Mỗi chương phải trả lời rõ: sau chương này nữ chính được gì, mất gì, phản diện lộ gì?
`.trim()
}
...
20.5. Chương này có một cú phản đòn cụ thể chưa? Nếu chỉ có chịu nhục + hứa tìm sự thật, phải thêm một hành động nhỏ có kết quả ngay: gửi sao kê, khóa quyền, hoàn vé, trả lì xì, yêu cầu mở lịch sử, gọi nhân chứng, giữ vật chứng hoặc khiến nhóm/căn phòng im lại.
20.6. Chương này có evidence step mới khác chương trước chưa? Nếu vẫn chỉ là cùng ảnh/file/phiếu/con dấu/metadata, phải đổi sang nguồn xác minh mới hoặc hậu quả mới.
20.7. Tiêu đề chương có trùng/cùng nghĩa với chương trước không? Nếu có, đổi tiêu đề theo state change mới.
